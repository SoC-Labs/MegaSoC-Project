...
ifeq ($(INC_SYNOPSYS_LPDDR4),yes)
	...
	DEFINES_VC += +define+DWC_DDRPHY_CUST_PHYREV=0 +define+DWC_DDRPHY_CUST_PUBREV=0 +define+DWC_PUB_RID=9248 +define+DWC_DDRPHY_NUM_TOP_SCAN_CHAINS=110
	ifeq ($(ASIC),no)
		...
		DEFINES_VC += +define+DWC_DDRPHY_HWEMUL +define+DWC_DDRPHY_HWEMUL_SIM +define+DWC_DDRPHY_SIMPLE_MODEL
